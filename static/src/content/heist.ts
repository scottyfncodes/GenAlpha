 ...
 * that. This is Helio's Bellhaven *operating* account — the contract float, a
  ...
  nodes: {
    hub: {
      ...
      choices: [
        ...
        {
          text: 'Ask Ines whether anyone’s selling on Helio.',
          goto: 'tip',
    ...
    assistant_trace: {
      id: 'assistant_trace',
      lines: [
        { text: 'Helio’s Bellhaven contract address is on page four of a public PDF, which is the safest place in the world to put something.' },
      ],
      minigame: {
        kind: 'hacking',
    ...
    tip: {
      id: 'tip',
      lines: [
        { speaker: 'Ines', text: 'Helio. Yeah. Hang on.' },
