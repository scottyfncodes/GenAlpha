...
export const ITEMS: GoodsItem[] = [
  ...
  },
  {
    ...
    basePrice: 420,
    category: 'gear',
    effect: 'Reads a FLACK housing now, not just a call box. SafeTrace’s own network, from the outside.',
  },
  {
    itemId: 'cyberdeck_4',
    name: 'Ghost Deck',
   ...
   * kamikaze run at a piece of SafeTrace's own infrastructure (the best payout
